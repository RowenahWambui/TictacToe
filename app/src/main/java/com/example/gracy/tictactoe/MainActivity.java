package com.example.gracy.tictactoe;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1View = (TextView) findViewById(R.id.player1text);
        player1View = (TextView) findViewById(R.id.player2text);
 ...
 private void updatePoints(){
    ...
    player2View.setText("Player 1: " + player2points);
 }
